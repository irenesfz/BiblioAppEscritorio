...
{
    class BotonReservaVisibilidadConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (libro != null)
                ...
                return api.GetUnidadesTotalesLibroPorId(libro.isbn) != api.GetUnidadesReservadasLibroPorId(libro.isbn);
            else return false;
        }
